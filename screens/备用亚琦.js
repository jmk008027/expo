      ...
      <View style={styles.dataContainer}>
        ...
        <View style={styles.dataRow}>
          <View style={styles.dataBox}>
            <Text style={styles.dataTitle}>当前流量（m³/L）:</Text>
            <Text style={styles.dataText}>{status.flow}</Text>
          </View>
          <View style={styles.dataBox}>
            <Text style={styles.dataTitle}>累计流量（m³）:</Text>
            <Text style={styles.dataText}>{status.totalFlow}</Text>
          </View>
        </View>
      </View>
